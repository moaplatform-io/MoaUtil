...
public class ExecuteThread2 extends AbstractBmtThread<BMTFlexSourceCode, ExecuteContract2Store> {

	private static final Logger log = LoggerFactory.getLogger(ExecuteThread2.class);
	...
	public ExecuteThread2(RunnerContext<BMTFlexSourceCode, ExecuteContract2Store> context, 
	...
	public void run() {
		// fetch resource file
		ExecuteContract2Store store = (ExecuteContract2Store) getResource();
