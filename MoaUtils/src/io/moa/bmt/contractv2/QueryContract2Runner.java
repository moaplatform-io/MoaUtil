...
public class QueryContract2Runner extends MoaRunnerContext<BMTFlexSourceCode, QueryContract2Store> {
	...
	public QueryContract2Runner(String[] args) throws Exception {
		super(args);
	}
	...
	public void initVariables() throws Exception {
		...
		resource = new QueryContract2Store(clientInfoFilePath, true);
		...
		throttlingTpsMap.put(QueryThread2.TYPE_NAME, throttlingTps);
	}
	...
	public void initThread() throws Exception {
		...
		for (int i = 0; i < threadNum; i++) {
			...
			addThread(new QueryThread2(this, createNextNodeClient(cacheSize), privateKey, contractAddress));
	...
	public static void main(String[] args) throws Exception {
		...
		// initialize context
		MoaRunnerContext<BMTFlexSourceCode, QueryContract2Store> context = new QueryContract2Runner(args);
		...
		while (false == context.isAllFinished()) {
			...
			if (lastT + 1000 < System.currentTimeMillis()) {
				...
				System.out.printf("%4d%14s\n", seq, progressMap.get(QueryThread2.TYPE_NAME));
