...
public class ExcuteContractRunner extends MoaRunnerContext<BMTFlexSourceCode, ExecuteContractStore> {
	...
	public ExcuteContractRunner(String[] args) throws Exception {
		super(args);
	}
	...
	public void initVariables() throws Exception {
		...
		resource = new ExecuteContractStore(clientInfoFilePath, true);
		...
		throttlingTpsMap.put(ExecuteThread.TYPE_NAME, throttlingTps);
	}
	...
	public void initThread() throws Exception {
		...
		for (int i = 0; i < threadNum; i++) {
			...
			addThread(new ExecuteThread(this, createNextNodeClient(cacheSize), privateKey, contractAddress));
	...
	public static void main(String[] args) throws Exception {
		...
		// initialize context
		MoaRunnerContext<BMTFlexSourceCode, ExecuteContractStore> context = new ExcuteContractRunner(args);
		...
		while (false == context.isAllFinished()) {
			...
			if (lastT + 1000 < System.currentTimeMillis()) {
				...
				System.out.printf("%4d%14s\n", seq, progressMap.get(ExecuteThread.TYPE_NAME));
