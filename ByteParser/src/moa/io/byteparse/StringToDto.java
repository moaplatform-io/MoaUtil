...
public class StringToDto {
	...
	public static void stringToDto(Object ins,String msg) throws IllegalArgumentException, IllegalAccessException, IOException {
		byte[] list=null;
		...
		ByteParseConverter.coverStringToDto(ins, filedList, msg);
	}
}
