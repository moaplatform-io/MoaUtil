...
public class ByteToDto {

	static Map<Class,List<MoaClassFieldInfo>> invokemap=new HashMap<Class,List<MoaClassFieldInfo>>();
	
	
	public static void byteToDto(Object ins,byte msg[]) throws IllegalArgumentException, IllegalAccessException, IOException {
		byte[] list=null;
		...
		ByteParseConverter.coverByteToDto(ins, filedList, msg);
	}
}
